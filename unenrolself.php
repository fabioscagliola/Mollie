...
$instance = $DB->get_record('enrol', ['id' => $enrolid, 'enrol' => 'coursepayment'], '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/coursepayment/unenrolself.php', ['enrolid' => $instance->id]);
...
$message = get_string('unenrolselfconfirm', 'enrol_coursepayment', format_string($course->fullname));
